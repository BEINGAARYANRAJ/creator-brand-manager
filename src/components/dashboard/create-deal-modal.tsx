...
export default function CreateDealModal({ open, onClose, onCreated }: {
  ...
  async function submit(e: React.FormEvent) {
    ...
    onClose();
    onCreated();
    setForm({ brandName: "", platform: "YOUTUBE", dealValue: "", currency: "USD", status: "NEGOTIATING", startDate: "", endDate: "", notes: "" });
  }
    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl w-full max-w-lg shadow-xl">
        <div className="flex items-center justify-between p-6 border-b">
          <h2 className="text-lg font-semibold text-gray-900">New Brand Deal</h2>
